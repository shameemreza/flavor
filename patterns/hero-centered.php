...
/**
 * Title: Hero - Centered
 * Slug: flavor/hero-centered
 * Categories: flavor_hero, featured
 * Keywords: hero, header, intro, about, centered, text
 * Block Types: core/group
 * Viewport width: 1200
 * Description: Centered hero section with text only.
 *
 * @package flavor
 * @since 1.0.0
 */
...
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60"}}},"backgroundColor":"surface","layout":{"type":"constrained","contentSize":"580px"}} -->
<div class="wp-block-group alignfull has-surface-background-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)">
	<!-- wp:heading {"textAlign":"center","level":1,"style":{"typography":{"fontSize":"2.5rem","fontWeight":"700","lineHeight":"1.25"},"spacing":{"margin":{"bottom":"0.5rem"}}}} -->
	<h1 class="wp-block-heading has-text-align-center" style="margin-bottom:0.5rem;font-size:2.5rem;font-weight:700;line-height:1.25"><?php esc_html_e( "Hi, I'm John Doe", 'flavor' ); ?></h1>
	<!-- /wp:heading -->
